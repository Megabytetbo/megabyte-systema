        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            <div className="flex justify-center mb-6">
              <img src="/MegaTallerPro_transparente.png" alt="MegaTallerPro" className="h-20 w-auto object-contain" style={{filter:"invert(1) sepia(1) saturate(5) hue-rotate(90deg)"}} />
            </div>
          </div>
      ...
      <div className="min-h-screen bg-zinc-950 text-white overflow-y-auto">
        ...
        <div className="border-b border-zinc-800 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/MegaTallerPro_transparente.png" alt="MegaTallerPro" className="h-12 w-auto object-contain brightness-0 saturate-100" style={{filter:"invert(1) sepia(1) saturate(5) hue-rotate(90deg)"}} />
          </div>
        ...
        <div className="text-center px-6 py-16">
          <div className="flex justify-center mb-8">
            <img src="/MegaTallerPro_transparente.png" alt="MegaTallerPro" className="h-28 w-auto object-contain" style={{filter:"invert(1) sepia(1) saturate(5) hue-rotate(90deg)"}} />
          </div>
      ...
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="text-center mb-10">
            <div className="flex justify-center mb-6">
              <img src="/MegaTallerPro_transparente.png" alt="MegaTallerPro" className="h-24 w-auto object-contain" style={{filter:"invert(1) sepia(1) saturate(5) hue-rotate(90deg)"}} />
            </div>
  ...
  return (
    <div className={`min-h-screen ${t.bg} ${t.text} flex`}>
      ...
      <div className={`md:hidden fixed top-0 left-0 right-0 z-40 ${t.sidebar} border-b ${t.divider} px-4 py-3 flex items-center justify-between`}
        ...
        <div className="flex items-center gap-2">
          <img src="/MegaTallerPro_transparente.png" alt="MegaTallerPro" className="h-8 w-auto object-contain" style={{filter:"invert(1) sepia(1) saturate(5) hue-rotate(90deg)"}} />
        </div>
